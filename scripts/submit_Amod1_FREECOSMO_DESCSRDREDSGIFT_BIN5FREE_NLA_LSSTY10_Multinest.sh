...
#SBATCH -t 12:00:00                                                         
#SBATCH -J LSSTY10AMOD1_FREECOSMOLOGY_DESCSRDREDSHIFT_BIN5_NLA                                                            
#SBATCH -A ASTRONOMY-SL3-CPU                                                     
#SBATCH --mail-user=cp662@cam.ac.uk                                     
#SBATCH --mail-type=ALL                                                                  
#SBATCH --error=./error_files/LSSTY10AMOD1_FREECOSMOLOGY_DESSRDREDSHIFT_BIN5_NLA.err                                   
#SBATCH --output=./out_files/LSSTY10AMOD1_FREECOSMOLOGY_DESCSRDREDSHIFT_BIN5_NLA.out                                                                    
...
export EXTRA_OUTPUT=
export MODEL_TAG=${PK_TYPE}-${IA_MODEL}-AMOD1LSSTY10AMOD1_FREECOSMOLOGY_DESCSRDREDSHIFT_BIN5FREE_NLA
export SAVE=                     
...
mpirun -ppn $mpi_tasks_per_node -np $np cosmosis --mpi inis/pipeline_LSSTY10SRDREDSHIFTS_BIN5FREE.ini -p runtime.sampler='multinest' multinest.resume=T multinest.live_points=500 multinest.tolerance=0.1 multinest.max_iterations=50000 multinest.efficiency=0.3 multinest.constant_efficiency=F
